	...
	render: function render() {
		return <header className="header-profile">
			<div className="imageProfileHeaderBlock">
				<img className="imageProfileHeader" src={this.state.croppedImg ? this.state.croppedImg :
					(this.props.profile && this.props.profile.gender == "female" 
						? "image/female_icon.png" : "image/male_icon.png")} />
