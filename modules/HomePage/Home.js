		...
		return <header id="first">
	        <div className="header-content">
	            <div className="inner">
	                ...
	                <hr />
	                <a className="btn btn-primary btn-xl header-link" id="login" data-l10n-id="logIn">Войти</a> &nbsp;
	                <a href="#" className="btn btn-primary btn-xl header-link" data-l10n-id="signUp">Зарегистрироваться</a>
	            </div>
	        </div>
	        <Video sources={["video/ru.mp4"]} autoPlay={true} constrols={false} width="100%" height="auto" loop={true}></Video>
	    </header>
	}
})
